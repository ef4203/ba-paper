...
%\begin{figure}
%  \centering
%  \includegraphics[page=1,width=0.3\textwidth]{fig/0}
...
\begin{figure}%
    ...
    \begin{subfigure}{\textwidth}
      \includegraphics[page=1,width=\textwidth]{fig/null}
      \caption{coverage}\label{fig:setup1}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
      \includegraphics[page=2,width=\textwidth]{fig/null}
...
\begin{table}
	\centering
	\begin{tabular}{l>{\raggedright}p{4cm}S[table-text-alignment=left,table-format=1.4e-1]l}
	\toprule
