...
\begin{table}[H]
	...
	\midrule
    \textbf{nginx} & 67.25 MB & 1.0 & 1.0 \\
    \textbf{mongo} & 246.58 MB & 1.0 & 1.0 \\
    \textbf{busybox} & 2.05 MB & 0.15 MB & \color{ba-green}{- 92\%} \\
    \textbf{mysql} & 174.94 MB & 1.0 & 1.0 \\
    \textbf{ruby} & 367.45 MB & 1.0 & 1.0 \\
    \textbf{httpd} & 61.53 MB & 1.0 & 1.0 \\
    \textbf{golang} & 285.59 MB & 1.0 & 1.0 \\
    \textbf{mariadb} & 117.04 MB & 1.0 & 1.0 \\
    \textbf{ubuntu} & 28.17 MB & 1.0 & 1.0 \\
    \textbf{node} & 382.26 MB & 1.0 & 1.0 \\
	\bottomrule
	\end{tabular}
	\caption{Container Image Download Size}
