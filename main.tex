\documentclass[earlydraft]{textmf-local/srathesis}
% options:
...
\input{cha/01-introduction}

\input{cha/02-fundamentals}

\input{cha/03-architecture}

\input{cha/04-analysis}

\input{cha/05-conclusion}
